...
const Layout = ({ children }: LayoutProps) => (
  <div className="relative bg-dark-bg transition-colors duration-200 overflow-x-hidden">
    ...
    <div className="relative z-10">
      <a
        href="#main-content"
        className="sr-only focus:not-sr-only focus:fixed focus:left-4 focus:top-4 focus:z-[60] focus:rounded-xl focus:bg-primary-500 focus:px-4 focus:py-2 focus:text-sm focus:font-semibold focus:text-white"
      >
        Saltar al contenido
      </a>
      <Navbar />
